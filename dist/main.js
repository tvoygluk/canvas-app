...
var drawTools = document.querySelector('.tools');
var curve = drawTools.querySelector('.tools__curve');
var clean = drawTools.querySelector('.tools__clean'); // Создание нового холста
...
var onCanvasMouseDown = function onCanvasMouseDown(evt) {
...
var onCanvasMouseUp = function onCanvasMouseUp(evt) {
  var line = new pixi_js__WEBPACK_IMPORTED_MODULE_1__["Graphics"]();
...
var onCurveClick = function onCurveClick() {
  curve.classList.toggle('active');
  curve.classList.contains('active') ? (canvas.addEventListener('mousedown', onCanvasMouseDown), canvas.addEventListener('mouseup', onCanvasMouseUp)) : (canvas.removeEventListener('mousedown', onCanvasMouseDown), canvas.removeEventListener('mouseup', onCanvasMouseUp));
...
var onCleanClick = function onCleanClick() {
